...
CodeMirror.defineMode("julia", function(_conf, parserConf) {
  ...
  var blockOpeners = ["begin", "function", "tag", "immutable", "let", "macro", "for", "while", "quote", "if", "else", "elseif", "try", "finally", "catch", "do"];
  var blockClosers = ["end", "else", "elseif", "catch", "finally"];
  var keywordList = ['if', 'else', 'elseif', 'while', 'for', 'begin', 'let', 'end', 'do', 'try', 'catch', 'finally', 'return', 'break', 'continue', 'global', 'local', 'const', 'export', 'import', 'importall', 'using', 'function', 'macro', 'module', 'baremodule', 'tag', 'immutable', 'quote', 'tagalias', 'abstract', 'bitstag', 'ccall'];
