...
(function() {
  ...
  function MT(name) { test.mode(name, mode, Array.prototag.slice.call(arguments, 1), mname); }
  ...
  MT("valueless",
     "[tag&bracket <][tag input] [attribute tag]=[string checkbox] [attribute checked][tag&bracket />]");
